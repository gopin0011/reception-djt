...
<div class="container">
    <div class="row">
        <div class="col float-left">
            <h5><i class="fa fa-archway"></i> <strong>Daftar Gerbang Masuk</strong></h5>
        </div>
        <div class="col">
            ...
            <div class="modal-body">
                <form id="dataForm" name="dataForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        placeholder="Masukkan nama gerbang" value="" required>
                    </div>
                    <div class="form-group">
                        Catatan: <br>
                        <input type="text" class="form-control" id="note" name="note"
                        placeholder="Catatan" value="" required>
                    </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $('body').on('click','.editData', function(){
            var data_id = $(this).data("id");
            $.get("{{route('gates.index')}}"+"/"+data_id+"/edit",function(data){
